...
import com.suman.Ecommerce_beckend.service.CartItemService;
...
public class CartItemController {
    ...
    public ResponseEntity<ApiResponse>deleteCartItem(@PathVariable Long cartItemId, @RequestHeader("Authorization")String jwt) throws CartItemException, UserException, UserException {
